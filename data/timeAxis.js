...
var timeAxisArr = [
		{
			...
			endTime:"2015.03.01",
			companyLogo:'images/icon/com_logo1.gif',
			companyNam:"中国资源卫星应用中心",
			companyWebsite:"http://www.cresda.com/",
			jobPost:"系统运维工程师",
			jonTask:"对日常卫星拍摄数据进行处理、分发和入库等操作",
			jobContent:"对日常卫星拍摄数据进行处理、分发和入库等操作，期间接触到了Linux系统，并且对互联网行业产生了兴趣",
		},
		{
		    startTime:"2015.10.20",
			endTime:"2016.03.01",
			companyLogo:'images/icon/com_logo2.png',
			companyNam:"中学学科网",
			companyWebsite:"http://www.zxxk.com",
			jobPost:"前端开发工程师",
			jonTask:"编写了各种专题页的静态页面",
